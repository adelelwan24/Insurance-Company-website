...
def AddHospital():
    if request.method == "POST":
        ...
        try:
            ...
            # db(f"INSERT INTO hospital values (default,'{Hospital_Name}','{specialization}',{Hospital_rating},'{Hospital_state}','{Hospital_city}','{Hospital_street}');")
        ...
        # records = db(f"SELECT max(ID) FROM hospital WHERE Hospital_name = '{Hospital_Name}';")
